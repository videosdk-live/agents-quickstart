...
class VoiceAgent(Agent):
    ...
    async def on_enter(self):
        await self.session.say("Hello! Press 1 for loan recovery. Press 2 for train loan assistance.")
...
def on_pubsub_message(message):
    ...
    if digit == "1":
        ...
        asyncio.create_task(agent.session.say("You selected loan recovery. How may I assist you?"))
        print("Loan Recovery context added.")
    elif digit == "2":
        agent.chat_context.add_message(
            role="system",
            content=(
        ...
        asyncio.create_task(agent.session.say("You selected train loan assistance. How may I help?"))
        print("Train Loan context added.")
    else:
