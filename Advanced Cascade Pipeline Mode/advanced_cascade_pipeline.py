import logging
from videosdk.agents import Agent, AgentSession, Pipeline, WorkerJob, JobContext, RoomOptions, EOUConfig, InterruptConfig
...
async def entrypoint(ctx: JobContext):
    ...
    # Cascade Pipeline Mode with advanced EOU and interrupt configuration
    pipeline = Pipeline(
        stt=DeepgramSTT(),
        llm=GoogleLLM(),
        tts=CartesiaTTS(),
